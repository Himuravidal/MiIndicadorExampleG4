package com.example.adacher.miindicadorexample;
...
import com.example.adacher.miindicadorexample.network.GetIndicatorByDate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new BackgroundUF().execute("uf", "12-06-2017");
                new BackgroundDolar().execute("dolar","12-06-2017");
